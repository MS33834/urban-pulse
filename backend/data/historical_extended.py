...
EXTENDED_HISTORICAL: dict[str, dict[int, dict[str, Any]]] = {
    "深圳": {
        ...
        2012: {
            ...
            "supplier_count": 3900,
            "land_price": 3400,
            "local_support_rate": 77.0,
            "policy_coverage": 83.0,
            "rd_subsidy": 10.0,
            "tax_reduction": 21.0,
        },
        2013: {
        ...
        2018: {
            ...
            "supplier_count": 4900,
            "land_price": 5000,
            "local_support_rate": 83.0,
            "policy_coverage": 89.0,
            "rd_subsidy": 14.5,
            "tax_reduction": 27.5,
        },
        2019: {
            ...
            "fiscal_revenue": 3773,
            "rd_intensity": 4.7,
            "industry_high_tech_ratio": 56.0,
            "gdp_growth": 6.6,
            "supplier_count": 5000,
            "land_price": 5100,
            "local_support_rate": 84.0,
        ...
        2022: {
            ...
            "supplier_count": 5180,
            "land_price": 5400,
            "local_support_rate": 85.8,
            "policy_coverage": 91.8,
            "rd_subsidy": 15.4,
            "tax_reduction": 29.0,
        },
        2023: {
        ...
        2024: {
            ...
            "supplier_count": 5195,
            "land_price": 5550,
            "local_support_rate": 86.2,
            "policy_coverage": 92.2,
            "rd_subsidy": 15.6,
            "tax_reduction": 29.3,
        },
        2025: {
            ...
            "supplier_count": 5200,
            "land_price": 5600,
            "local_support_rate": 86.5,
            "policy_coverage": 92.5,
            "rd_subsidy": 15.8,
            "tax_reduction": 29.5,
        },
    },
    "上海": {
        ...
        2022: {
            ...
            "supplier_count": 4820,
            "land_price": 6800,
            "local_support_rate": 82.8,
            "policy_coverage": 88.8,
            "rd_subsidy": 12.5,
            "tax_reduction": 25.8,
        },
        2023: {
        ...
        2024: {
            ...
            "supplier_count": 4805,
            "land_price": 6800,
            "local_support_rate": 83.2,
            "policy_coverage": 89.2,
            "rd_subsidy": 12.9,
            "tax_reduction": 26.2,
        },
        2025: {
    ...
    "北京": {
        ...
        2011: {
            ...
            "supplier_count": 3400,
            "land_price": 4600,
            "local_support_rate": 71.0,
            "policy_coverage": 79.0,
            "rd_subsidy": 15.0,
            "tax_reduction": 18.0,
        },
        2012: {
        ...
        2013: {
            ...
            "supplier_count": 3800,
            "land_price": 5500,
            "local_support_rate": 73.0,
            "policy_coverage": 81.0,
            "rd_subsidy": 17.0,
            "tax_reduction": 20.0,
        },
        2014: {
        ...
        2021: {
            ...
            "fiscal_revenue": 5932,
            "rd_intensity": 6.1,
            "industry_high_tech_ratio": 60.5,
            "gdp_growth": 11.6,
            "supplier_count": 4520,
            "land_price": 7500,
            "local_support_rate": 78.2,
        ...
        2022: {
            ...
            "supplier_count": 4520,
            "land_price": 7500,
            "local_support_rate": 78.3,
            "policy_coverage": 85.3,
            "rd_subsidy": 18.3,
            "tax_reduction": 22.3,
        },
        2023: {
            ...
            "supplier_count": 4510,
            "land_price": 7500,
            "local_support_rate": 78.4,
            "policy_coverage": 85.4,
            "rd_subsidy": 18.4,
            "tax_reduction": 22.4,
        },
        2024: {
    ...
    "广州": {
        ...
        2016: {
            ...
            "supplier_count": 3900,
            "land_price": 4200,
            "local_support_rate": 77.5,
            "policy_coverage": 83.5,
            "rd_subsidy": 11.5,
            "tax_reduction": 23.5,
        },
        2017: {
        ...
        2022: {
            ...
            "supplier_count": 4170,
            "land_price": 5100,
            "local_support_rate": 80.3,
            "policy_coverage": 86.8,
            "rd_subsidy": 14.2,
            "tax_reduction": 27.3,
        },
        2023: {
    ...
    "杭州": {
        ...
        2022: {
            ...
            "supplier_count": 3480,
            "land_price": 4400,
            "local_support_rate": 83.8,
            "policy_coverage": 88.2,
            "rd_subsidy": 16.2,
            "tax_reduction": 30.2,
        },
        2023: {
    ...
    "武汉": {
        ...
        2011: {
            ...
            "fiscal_revenue": 712,
            "rd_intensity": 2.2,
            "industry_high_tech_ratio": 34.5,
            "gdp_growth": 22.6,
            "supplier_count": 1700,
            "land_price": 1900,
            "local_support_rate": 71.0,
            "policy_coverage": 76.0,
            "rd_subsidy": 6.0,
            "tax_reduction": 17.0,
        },
        2012: {
        ...
        2016: {
            ...
            "supplier_count": 2700,
            "land_price": 2900,
            "local_support_rate": 75.5,
            "policy_coverage": 80.5,
            "rd_subsidy": 10.5,
            "tax_reduction": 22.0,
        },
        2017: {
        ...
        2018: {
            ...
            "supplier_count": 3050,
            "land_price": 3300,
            "local_support_rate": 76.5,
            "policy_coverage": 81.5,
            "rd_subsidy": 11.5,
            "tax_reduction": 24.0,
        },
        2019: {
...
def get_city_indicator(city: str, indicator: str, year: int | None = None) -> Any:
    ...
    return {
        ...
        "provenance": {
            ...
            "estimated": False,
            "confidence": 0.95,
            "methodology_change": "2020 人口口径变更(常住→实际管理)"
            if year >= 2020 and indicator == "population"
            else None,
...
def get_data_coverage(city: str | None = None) -> dict[str, Any]:
    ...
    for c in cities:
        ...
        for year, indicators in years_data.items():
            year_coverage[year] = {ind: indicators.get(ind) is not None for ind in INDICATOR_META}
        coverage[c] = {
            "years": sorted(years_data.keys()),
            "year_count": len(years_data),
            "indicators_per_year": year_coverage,
            "completeness": sum(1 for ind_map in year_coverage.values() for covered in ind_map.values() if covered)
